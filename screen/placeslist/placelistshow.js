      ...
      <View style={styles.container}>
        <ImageBackground source={require("../src/bg.png")}>
          <View style={styles.titlePart}>
            <Text style={styles.titleMain}>Places to visit</Text>
          </View>
          <ScrollView style={{ marginBottom: 120 }}>
            <TouchableOpacity
              onPress={() => {
                navigation.navigate("NineArch");
              }}
            >
              <View style={styles.list}>
                <Image
                  source={{
                    ...
                    height: 200,
                    uri: "https://windows10spotlight.com/wp-content/uploads/2022/10/637b7894db131e5d9b3d2bbb16ec1c7c-1024x576.jpg",
                  }}
            ...
            <TouchableOpacity
              onPress={() => {
                navigation.navigate("VictoriaPark");
              }}
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Victoria park</Text>
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Gregory");
              }}
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Lake Gregory</Text>
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Hakgala");
              }}
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}> Hakgala </Text>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Ambuluwawa");
              }}
            >
              <View style={styles.list}>
                <Image
            ...
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Hortan Place </Text>
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Arugambay");
              }}
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Arugambay </Text>
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Yala");
              }}
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Yala </Text>
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Udawalawa");
              }}
            >
              <View style={styles.list}>
                <Image
            ...
            <TouchableOpacity
              onPress={() => {
                navigation.navigate("RawanaFalls");
              }}
            >
              <View style={styles.list}>
                <Image
            ...
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Adam's peek </Text>
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Templetooth");
              }}
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Temple tooth </Text>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Peradeniya");
              }}
              style={styles.imgliststyle}
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Peradeniya </Text>
              </View>
            </TouchableOpacity>
            ...
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Sinharaja </Text>
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Unawatuna");
              }}
              style={styles.imgliststyle}
            >
              <View style={styles.list}>
                ...
                />
                <Text style={styles.title}>Unawatuna </Text>
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                navigation.navigate("BahirawaKanda");
              }}
              style={styles.imgliststyle}
            >
              <View style={styles.list}>
            ...
            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Ruwanweliseya");
              }}
              style={styles.imgliststyle}
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Ruwanwalisaya </Text>
              </View>
            </TouchableOpacity>
            ...
            >
              <View style={styles.list}>
                <Image
                  ...
                  style={styles.imgliststyle}
                />
                <Text style={styles.title}>Dehiwala Zoo </Text>
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                navigation.navigate("Nallur");
              }}
            >
              <View style={styles.list}>
                <Image
            ...
            <TouchableOpacity
              onPress={() => {
                navigation.navigate("JaffnaFort");
              }}
            >
              <View style={styles.list}>
                <Image
            ...
            <View style={styles.list}>
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate("Koneshwaram");
                }}
              >
                <Image
                  source={{
