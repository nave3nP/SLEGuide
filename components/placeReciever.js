...
const EntityList = ({ entityType }) => {
  ...
  const entityImages = {
    hotels: require("../assets/Images/hotel.png"),
  ...
  const renderItem = ({ item }) => (
    <View style={styles.item}>
      ...
      <View style={styles.adapter}>
        ...
        <Text style={styles.detailsText}>Popular package: {item.popPackage}</Text>
        <Text style={styles.detailsText}>Package Price: ${item.packagePrice}</Text>
